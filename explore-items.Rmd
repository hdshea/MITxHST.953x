---
title: "explore-items-SQLite version"
...
(This version was created from the MySQL version on the MIMIC-III github site.  It has been adapted to SQLite.)
...
```{r, warning=FALSE}
qry <- "select category, count(*) N, group_concat(label, ', ') LABELS
        from D_ITEMS 
        where category is not null 
        group by category"
item_summary <- dbGetQuery(mimic3, qry)
